  ...
  return (
    <div className="home-container">
      ...
      <section className="abtbg">
        <img src="public/long.jpeg" alt="Hero" className="abtbg-image" />
      ...
      <div className="abts2video">
        <video width="400" controls>
          <source src="public/Kiara & Sidharth _ Ranjha _ The Wedding Filmer.mp4" type="video/mp4" />
   ...
   <h1>
    ...
    <div className="abts3">
      ...
      <div className="abts3item">
        <img src="public/meet2.jpeg" alt="Image 1" className="abts3image" />
      ...
      <div className="abts3item">
        <img src="public/man.jpeg" alt="Image 2" className="abts3image" />
      ...
      <div className="abts3item">
        <img src="public/meet1.jpeg" alt="Image 3" className="abts3image" />
        <h2>Transparency</h2>
    ...
    <div className='ourstoryheading'><h1>Our <b>story</b></h1></div>
      <section className="ourstory">
        ...
        <div className='ourstoryphoto'>
          ...
          <img src="public/mix.jpeg" alt="Image 1" />
