        ...
        <div className="footer-column">
          ...
          <div className="logocont">
               <div className="logoimg">
                      <img src="public/footerlogo.png" alt="Image description" />
                  </div>
          ...
          <div className="social-media">
            <a href="https://facebook.com" target="_blank" rel="noopener noreferrer">
              <img src="public/social 3.png" alt="Facebook" className="social-icon" />
            </a>
            <a href="https://twitter.com" target="_blank" rel="noopener noreferrer">
              <img src="public/social1.png" alt="Twitter" className="social-icon" />
            </a>
            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer">
              <img src="  public/social2.png" alt="Instagram" className="social-icon" />
            </a>
          </div>
        </div>
